        ...
        <div class="row row-30">
            <div class="col-md-4 col-xl-5">
                <div class="pr-xl-4">
                    <br>
                    <br>
                    <p>Дипломный проект - консолидированные отчеты товрооборота.</p>
                </div>
            </div>
            <div class="col-md-4">
                <br>
                ...
                <dl class="contact-list">
                    <dt>Адрес:</dt>
                    <dd>г. Минск, улица Л. Беды, 4б</dd>
                </dl>
                <dl class="contact-list">
                    <dt>Почта:</dt>
                    <dd><a href="mailto:#">tavluy1999@mail.ru</a></dd>
                </dl>
                <dl class="contact-list">
                    <dt>Телефон:</dt>
                    <dd><a href="tel:#">80298295603</a>
                    </dd>
                </dl>
            </div>
